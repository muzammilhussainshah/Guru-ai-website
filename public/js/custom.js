...
function scrollToSection(sectionId, element) {
	...
	var buttons = document.querySelectorAll('.navBarButtons .nav-link');
...
function scrollToSectionForMenu(sectionId, element) {
	// Remove 'active' class from all buttons
	var buttons = document.querySelectorAll('.menuButtons .nav-link');
	buttons.forEach(function (button) {
		button.classList.remove('active');
	});
	// Add 'active' class to the clicked button
...
function resetPrevent(event) {
	event.preventDefault(); // Prevent the default action of the anchor element
	// Add your send now functionality here
}

// nav bar collaspe functionality
